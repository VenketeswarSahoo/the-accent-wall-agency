...
const ProcessSection = ({ dict }: ProcessSectionProps) => {
  ...
  const highlightWord = headline.includes("in weeks.")
    ? "in weeks."
    : "en semanas.";
    ...
    >
      <div className="relative z-10 flex flex-col gap-12 lg:gap-20">
        ...
        <div className="relative flex flex-col">
          <Mandala
            variant="mandala-1"
            className="absolute top-[-35%] right-[-25%] w-[95vw] h-[95vw] max-w-[1100px] max-h-[1100px] text-primary/25 pointer-events-none select-none z-0"
            speed={500}
          />
